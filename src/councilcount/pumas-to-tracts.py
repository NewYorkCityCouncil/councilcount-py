...
path = files("councilcount").joinpath("data")
...
# Manually fill in missing PUMAs for populated BBLs in 2021 and 2022 (this was done by looking up the addresses of the BBLs and comparing to a map of 2010 PUMAs)
# The populated BBLs missing 2010 PUMAs are identical in both years.
manual_fixes = {"23801": "04109", "24200": "03710"}
bbl_population[2021]["puma2010"] = bbl_population[2021]["puma2010"].fillna(bbl_population[2021]["ct2010"].map(manual_fixes))
bbl_population[2022]["puma2010"] = bbl_population[2022]["puma2010"].fillna(bbl_population[2022]["ct2010"].map(manual_fixes))

# Make sanity checks and write new files
